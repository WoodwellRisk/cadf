...
// the 6 lead-month date labels following an initialization date,
// e.g. '1991-01-01' → ['1991-02-01', ..., '1991-07-01']
export const generateLeadDates = (initializationDate, numLeads = 6) =>
